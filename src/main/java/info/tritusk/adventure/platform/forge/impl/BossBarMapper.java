...
public class BossBarMapper {
    ...
    public static ServerBossInfo toNative(BossBar bar) {
        final ServerBossInfo nativeBossBar =
            new ServerBossInfo(TextComponentMapper.toNative(bar.name()), BossBarMapper.toNative(bar.color()), BossBarMapper.toNative(bar.overlay()));
